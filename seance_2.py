...
for chaque_personne in listePER:
    print ( " Hello "+ chaque_personne )
    print(" How are you "+ chaque_personne)
    print(" bye bye "+ chaque_personne)
...
#exo Implémenter une fonction qui prend une liste en argument et retourne sa longeur.
